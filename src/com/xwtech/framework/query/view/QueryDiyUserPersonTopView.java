 ...
 */
public class QueryDiyUserPersonTopView extends IQueryView
{
  /**
  ...
  {
    out.println("<table border='0' align='center'  cellspacing='0' cellpadding='0' width='100%'>");
  }
  ...
  {
    out.println("<table width=\"572\" id=\""+this.qInfo.getTableId()+ "\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"#FFFFFF\">");
  }


  protected void outputDataListColStyle(int nCol)
  {
    out.print(" class='td_bottom_line_2'");
  }
  ...
  {
     out.print(" height=\"35\" ");
     out.print(" background=\"/cring/image/diy/personal_space_r6_c1.gif\"");
     out.print(" class=\"font_title\" ");
  }
  ...
  {
    out.println("<table width=\"572\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"#FFFFFF\">");
  }
