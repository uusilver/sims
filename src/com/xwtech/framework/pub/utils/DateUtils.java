...
public class DateUtils {
	...
	public static String formatFullTimeToChar14(String fullTime) {
		return StringUtils.replace(StringUtils.replace(StringUtils.replace(fullTime, "-", ""), ":", ""), " ", "");
	}
	...
	public static void main(String[] args) {
		// String char3 = formatDate("2007-02-02", "yyyy-MM-dd", "yyyyMMdd");
		//
		// System.out.println(char3);

		// 测试月份滚动
		// eg:20081013,2->20081213;
		// 20081013,3->20090113;
		// 20080213,-1->20080113
		// 20080213,-2->20071213;
		...
		// 测试正向滚动
//		for (int i = 1; i < 20; i++) {
//			System.out.println("20080213," + i + ": " + rollMonth("20080213", String.valueOf(i)));
//		}
...
//		System.out.println(getDaysInMonth(2008,2));
		// String fd = formatDate("2007-02-02", "yyyyMMddHHmmss");
