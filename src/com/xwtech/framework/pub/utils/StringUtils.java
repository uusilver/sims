...
public class StringUtils
{
  ...
  {
    String resultStr = "";
    String[] subStrArr = str.split(splitStr);
  ...
  public static ArrayList toArrayList(String src, String splitStr)
  {
    ...
    String[] ringIdArr = src.split(splitStr);
   ...
   * hashKey()
   * @param data ��Ҫ���ܵ��ַ�
   * @param type �������� ��"MD5" or "SHA-1"��
   * @return ���صļ����ִ���SHA1�ǲ���һ��20�ֽڵĶ���������
   */
  public synchronized static final String hashKey(String data, String type)
  {
  ...
  /**
   * from format String get random String
   * format example:
   *                xxx888   =>  abc123
   *                XXX888xxx888xxxXXX  => ABC123abc123abcABC
   * x : lowcase char 'a' - 'z'
   * X : uppercase char 'A' - 'Z'
   * 8 : number char '0' - '9'
   * M : lowcase or uppercase char or number char
   * @param format String
   * @return String
   */
  public static final String getRandomString(String format)
  {
    StringBuffer sb = new StringBuffer();
    Random r = new Random();
  ...
  //密码
  public static String decode(String Uno, String keyD, String keyN)
  {
    int msgLen = Uno.length() / 4;
    StringBuffer resultSb = new StringBuffer();
    for(int i = 0; i < msgLen; i++)
    {
      String s4 = Uno.substring(i * 4, i * 4 + 4);
      String decimalS4 = Integer.decode("0x" + s4).toString();
      resultSb.append(Crypt(decimalS4, keyD, keyN));
    }
    return resultSb.toString();
  }

  //解码
  private static char Crypt(String msg, String keyD, String keyN)
  {
    BigInteger biMsg = new BigInteger(msg);
    BigInteger biKeyD = new BigInteger(keyD);
    BigInteger biKeyN = new BigInteger(keyN);
    BigInteger biTwo = new BigInteger("2");
    BigInteger lLngResult = biMsg;
    for(int i = 0; i < biKeyD.divide(biTwo).intValue(); i++)
    {
      BigInteger lonMod = biMsg.modPow(biTwo, biKeyN);
      lLngResult = (lonMod.multiply(lLngResult)).mod(biKeyN);
    }
    return(char)lLngResult.byteValue();
  }
  /**
   * 将字符串换成中文的
   * @param s String
   * @return String
   */
  public static String chgeToGBK(String s)
  {
    try
   {
  ...
  public static String chgeToUTF(String s)
  {
    try
   {
