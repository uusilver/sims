package com.xwtech.framework.pub.web;
...
import com.xwtech.framework.pub.dao.BaseHibernateDAO;
...
//import com.xwtech.mss.pub.po.DmsTimeLimit;
import com.xwtech.mss.pub.web.SysOperLog;
import com.xwtech.cring.pub.web.CringProperties;
...
public class FrameworkApplication implements InitializingBean {
	...
	// 彩铃系统配置属性类
	public static CringProperties cringProperties;
	...
	public static BaseHibernateDAO baseHibernateDAO;
	...
	public void setDbCollection(DbCollection dbCollection) {
		FrameworkApplication.dbCollection = dbCollection;
	}

	public void setCringProperties(CringProperties cringProperties) {
		this.cringProperties = cringProperties;
	}
	 ...
	 * @throws Exception
	 */
	public static void refreshCacheByPojoName(String pojoName, String hql)
			throws Exception {
		try {
			List l = baseHibernateDAO.getHibernateTemplate().find(hql);
