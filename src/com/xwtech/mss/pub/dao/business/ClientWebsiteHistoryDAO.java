...
import com.xwtech.mss.pub.po.ClientWebsiteHistory;
 ...
 * 
 * @see com.xwtech.mss.pub.dao.business.ClientWebsiteHistory
	...
	public ClientWebsiteHistory findById(java.lang.Integer id) {
		...
		try {
			ClientWebsiteHistory instance = (ClientWebsiteHistory) getSession()
					.get("com.xwtech.mss.pub.dao.business.ClientWebsiteHistory",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(ClientWebsiteHistory instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"com.xwtech.mss.pub.dao.business.ClientWebsiteHistory")
