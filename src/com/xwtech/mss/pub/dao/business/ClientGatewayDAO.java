...
import com.xwtech.mss.pub.po.ClientGateway;
 ...
 * 
 * @see com.xwtech.mss.pub.dao.business.ClientGateway
	...
	public ClientGateway findById(java.lang.Integer id) {
		...
		try {
			ClientGateway instance = (ClientGateway) getSession().get(
					"com.xwtech.mss.pub.dao.business.ClientGateway", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(ClientGateway instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"com.xwtech.mss.pub.dao.business.ClientGateway")
