...
public class CountryJModel {
	private String id;
	private String text;
	private List<ProvinceJModel> children;
	...
	public List<ProvinceJModel> getChildren() {
		return children;
	}
	public void setChildren(List<ProvinceJModel> children) {
		this.children = children;
	}
