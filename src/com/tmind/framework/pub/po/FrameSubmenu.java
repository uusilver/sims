package com.tmind.framework.pub.po;
...
public class FrameSubmenu implements Serializable {
    ...
    /** persistent field */
    private com.tmind.framework.pub.po.FrameUrl frameUrl;

    /** persistent field */
    private com.tmind.framework.pub.po.FrameMenu frameMenu;

    /** persistent field */
    private Set frameRoleSubmenus;

    /** full constructor */
    public FrameSubmenu(Long submenuId, String submenuName, int submenuSort, String submenuState, com.tmind.framework.pub.po.FrameUrl frameUrl, com.tmind.framework.pub.po.FrameMenu frameMenu, Set frameRoleSubmenus) {
    ...
    public com.tmind.framework.pub.po.FrameUrl getFrameUrl() {
        return this.frameUrl;
    }

    public void setFrameUrl(com.tmind.framework.pub.po.FrameUrl frameUrl) {
        this.frameUrl = frameUrl;
    }

    public com.tmind.framework.pub.po.FrameMenu getFrameMenu() {
        return this.frameMenu;
    }

    public void setFrameMenu(com.tmind.framework.pub.po.FrameMenu frameMenu) {
        this.frameMenu = frameMenu;
    }
