...
public class FrameLoginRole implements Serializable {
    ...
    /** persistent field */
    private com.tmind.framework.pub.po.FrameLogin frameLogin;

    /** full constructor */
    public FrameLoginRole(Long loginRoleId, String loginRoleState, com.tmind.framework.pub.po.FrameRole frameRole, com.tmind.framework.pub.po.FrameLogin frameLogin) {
    ...
    public com.tmind.framework.pub.po.FrameLogin getFrameLogin() {
        return this.frameLogin;
    }

    public void setFrameLogin(com.tmind.framework.pub.po.FrameLogin frameLogin) {
        this.frameLogin = frameLogin;
    }
