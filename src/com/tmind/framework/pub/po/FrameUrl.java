...
public class FrameUrl implements Serializable {
    ...
    /** full constructor */
    public FrameUrl(Long urlId, String urlValue, String urlName, String urlDesc, String urlState, com.tmind.framework.pub.po.FrameRole frameRole, Set frameSubmenus, Set frameButtonUrls) {
        this.urlId = urlId;
    ...
    /** minimal constructor */
    public FrameUrl(Long urlId, String urlValue, String urlName, String urlState, com.tmind.framework.pub.po.FrameRole frameRole, Set frameSubmenus, Set frameButtonUrls) {
        this.urlId = urlId;
        this.urlValue = urlValue;
        this.urlName = urlName;
        this.urlState = urlState;
