...
public class FrameRoleSubmenu implements Serializable {
    ...
    /** persistent field */
    private com.tmind.framework.pub.po.FrameRole frameRole;

    /** persistent field */
    private com.tmind.framework.pub.po.FrameSubmenu frameSubmenu;

    /** full constructor */
    public FrameRoleSubmenu(Long roleSubmenuId, String roleSubmenuState, com.tmind.framework.pub.po.FrameRole frameRole, com.tmind.framework.pub.po.FrameSubmenu frameSubmenu) {
    ...
    public com.tmind.framework.pub.po.FrameRole getFrameRole() {
        return this.frameRole;
    }

    public void setFrameRole(com.tmind.framework.pub.po.FrameRole frameRole) {
        this.frameRole = frameRole;
    }

    public com.tmind.framework.pub.po.FrameSubmenu getFrameSubmenu() {
        return this.frameSubmenu;
    }

    public void setFrameSubmenu(com.tmind.framework.pub.po.FrameSubmenu frameSubmenu) {
        this.frameSubmenu = frameSubmenu;
    }
