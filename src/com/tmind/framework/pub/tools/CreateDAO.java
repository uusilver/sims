package com.tmind.framework.pub.tools;
...
public class CreateDAO
{
  ...
  private String path = "com/tmind/cring/pub/dao";

  //工程源码路径（需要修改）
  private String projectPath = "c:/src";

  //需要引用的po的包路径 如：import com.tmind.cring.pub.po
  private String poPackagePath = "com.tmind.cring.pub.po";
  ...
  public static void main(String[] args)
  {
    ...
    String path = "D:/NewPlatForm/Services/clportal/projectsrc/src/com/tmind/cring/pub/po";
