...
import com.tmind.framework.pub.utils.SoapUtils;
import com.tmind.framework.pub.utils.SqlString;
import com.tmind.framework.pub.web.BaseFrameworkApplication;
import com.tmind.framework.query.bo.IHtmlet;
import com.tmind.mss.pub.tools.ChineseSpellingToPinYin;
    ...
    else
    {
      ...
      else
      {
        ...
        if(next.equals("true"))
        {
        	...
        	body = body.append(" document.all." + selectId + mn + ".dispatchEvent(evt);\n");
