...
import com.tmind.framework.query.QueryException;
import com.tmind.framework.query.QueryExhibit;
import java.net.URL;
import org.jdom.Document;
import com.tmind.framework.pub.utils.CalTime;
import com.tmind.framework.pub.utils.StringUtils;
import com.tmind.framework.pub.utils.LogUtils;
import com.tmind.framework.pub.utils.JdomUtils;
import com.tmind.framework.pub.utils.Assert;
...
public class QueryByXml implements IQuery, IJdomConfig
{
  ...
  private static final String DEFAULT_QUERY_VALUE_FETCH_CLASS = "com.tmind.framework.query.bo.QueryValueFetchByJdbcSql";
  ...
  public boolean init()
  {
    ...
    if(eleQueryCondition == null)
    {
      ...
      queryConditionClass = "com.tmind.framework.query.bo.QueryConditionByXml";
