package com.tmind.mss.pub.dao.system;
...
import com.tmind.mss.pub.po.FrameOrgCityRelation;

/**
 * Data access object (DAO) for domain model class FrameOrgCityRelation.
 * @see com.tmind.mss.pub.po.FrameOrgCityRelation
    ...
    public FrameOrgCityRelation findById( java.lang.Long id) {
        ...
        try {
            FrameOrgCityRelation instance = (FrameOrgCityRelation) getHibernateTemplate()
                    .get("com.tmind.mss.pub.po.FrameOrgCityRelation", id);
            return instance;
        } catch (RuntimeException re) {
