...
import com.tmind.mss.pub.po.ClientStatus;
 ...
 * 
 * @see com.tmind.mss.pub.dao.business.ClientStatus
	...
	public ClientStatus findById(java.lang.Integer id) {
		...
		try {
			ClientStatus instance = (ClientStatus) getSession().get(
					"com.tmind.mss.pub.dao.business.ClientStatus", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(ClientStatus instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"com.tmind.mss.pub.dao.business.ClientStatus")
