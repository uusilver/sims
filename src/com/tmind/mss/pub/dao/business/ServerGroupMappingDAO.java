 ...
 * 
 * @see com.tmind.mss.pub.dao.business.ServerGroupMapping
	...
	public ServerGroupMapping findById(java.lang.Integer id) {
		...
		try {
			ServerGroupMapping instance = (ServerGroupMapping) getSession()
					.get("com.tmind.mss.pub.dao.business.ServerGroupMapping",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(ServerGroupMapping instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"com.tmind.mss.pub.dao.business.ServerGroupMapping")
