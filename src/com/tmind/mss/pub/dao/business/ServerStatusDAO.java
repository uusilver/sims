...
import com.tmind.mss.pub.po.ServerStatus;
 ...
 * 
 * @see com.tmind.mss.pub.dao.business.ServerStatus
	...
	public ServerStatus findById(java.lang.Integer id) {
		...
		try {
			ServerStatus instance = (ServerStatus) getSession().get(
					"com.tmind.mss.pub.dao.business.ServerStatus", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(ServerStatus instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"com.tmind.mss.pub.dao.business.ServerStatus")
