...
import com.tmind.mss.pub.UserLoginToken;
 ...
 * @param doType:  调用com.tmind.mss.pub.constants.SysOperLogConstants方法.1:新增；2：修改；3：删除；4：作废；5：回复；6：确认
 * @param tableName:操做的数据库表名，如mpms_operation_log
 * @param doObject:操做的表对应的记录的ID
 * @param objType:调用com.tmind.mss.pub.constants.SysOperLogConstants方法.
